export const sk = {
  ...
  hero: {
    ...
    subtitle: "Komfort, individuálny prístup k zákazníkom a vysoká úroveň služieb.",
    bookButton: "Rezervovať na Bookio",
    circleText: "DOTYK ELEGANCIE PRE TVOJU PLEŤ • KRÁSA, KTORÁ TRVÁ •",
  },
    ...
    items: [
      {
        ...
        description: "Profesionálne a bezbolestné odstránenie chĺpkov pomocou najmodernejších technológií.",
      },
      {
        title: "Tvárové ošetrenia",
        description: "Ošetrenia pleti prispôsobené vašim potrebám, vrátane čistenia, hydratácie a omladenia.",
      },
      {
        title: "Telové ošetrenia",
        description: "Ošetrenia tela zamerané na spevnenie, detoxikáciu a relaxáciu.",
      },
      {
        title: "Vlasové procedúry",
        description: "Procedúry na zlepšenie zdravia a vzhľadu vlasov.",
      },
    ],
    note: "Návšteva salónu je možná len po objednaní, s platným očkovacím preukazom alebo prekonaním choroby v posledných 6 mesiacoch!",
  },
  ...
  about: {
    ...
    paragraph1:
      "Salón krásy Gigi Corner bol založený s vášňou pre krásu a záväzkom k dokonalosti. Našou misiou je poskytnúť útočisko, kde sa klienti môžu uvoľniť, omladiť a transformovať.",
    paragraph2:
    ...
    paragraph3:
      "V Gigi Corner-y veríme, že krása nie je len o vzhľade—je o pocite sebavedomia a pohodlia vo vlastnej koži. Vytvárame teplé, príjemné prostredie, kde každý klient dostáva personalizovanú pozornosť a odchádza s pocitom osvieženia a revitalizácie.",
  },
...
},
{
  ...
  benefits:
    ...
    professionalGrade: "Profesionálna kvalita",
    certifiedResults: "Certifikované výsledky",
  },
  ...
  pricing: {
    ...
    additionalInfo: {
      ...
      items: [
        "Ceny sa môžu líšiť v závislosti od dĺžky vlasov, hustoty alebo zložitosti služby",
        "Pre nových klientov odporúčame konzultáciu",
        "Zrušenie vyžaduje 24-hodinové upozornenie, aby sa predišlo 50% poplatku za službu",
        "Pre pravidelných klientov sú k dispozícii balíčkové ponuky a vernostné zľavy",
        "Darčekové poukážky sú k dispozícii na všetky služby",
      ],
    },
    genericDescriptions: {
      hair: "Profesionálna služba s prémiovými produktmi",
  ...
  { service: "Stehná", price: "70.00 €", duration: "15 min" }
    ...
    faceServices: [      ,
      { service: "AQUA FACIAL", price: "90.00 €", duration: "1h" },
  { service: "CARBONPEEL THERAPY", price: "90.00 €", duration: "1h" },
  { service: "Hĺbkové čistenie pleti", price: "75.00 €", duration: "1h 30min." },
  { service: "Stop Akné", price: "130.00 €", duration: "45min." },
  { service: "SQT Biomicroneedling ANTI AGE na vrásky", price: "190.00 €", duration: "1h 15min." },
  { service: "EXOSOMY SMART Therapy Tvár", price: "190.00 €", duration: "1h" },
  { service: "EXOSOMY SMART Therapy Tvár+Krk", price: "250.00 €", duration: "1h 15min." },
  { service: "Polynukleotidy X-DNA", price: "100.00 €", duration: "1h" },
  { service: "SQT Biomicroneedling NOURISHING Hydrating", price: "160.00 €", duration: "1h 15min." },
  { service: "SQT Biomicroneedling RESURFACING", price: "160.00 €", duration: "1h 15min." },
  { service: "SQT Biomicroneedling REVITALIZING", price: "160.00 €", duration: "1h 15min." },
  { service: "FACE CONTOUR LIFTING MASSAGE", price: "75.00 €", duration: "1h" },
  { service: "GLASSKIN BY SINDY", price: "90.00 €", duration: "1h" },
  { service: "KOBIDO Lifting therapy", price: "130.00 €", duration: "1h 30min." },
  { service: "LYMPHATIC SPOT TREATMENT BY SINDY", price: "100.00 €", duration: "1h" },
  { service: "LYMPHATIC SPOT TREATMENT BY SINDY", price: "120.00 €", duration: "1h 15min." },
  { service: "SKIN CEREMONY by Veronika", price: "90.00 €", duration: "1h 15min." },
  { service: "Tactum Therapy", price: "120.00 €", duration: "1h" },
  { service: "BE GiGi personalizované ošetrenie", price: "100.00 €", duration: "1h 15min." },
  { service: "COSMELAN", price: "399.00 €", duration: "1h" },
  { service: "LED Therapy", price: "40.00 €", duration: "50min." },
  { service: "Stop Rosacea", price: "130.00 €", duration: "45min." },
  { service: "DERMAPLANING", price: "70.00 €", duration: "1h" },
    ],
    bodyServices: [
  ...
  // CTA Section
  cta: {
    title: "Pripravení zažiť luxus?",
    subtitle: "Rezervujte si termín ešte dnes a nechajte našich odborníkov postarať sa o vaše potreby krásy.",
    button: "Rezervovať na Bookio",
  },

  // Footer
  footer: {
    tagline: "Vytvárame krásu a pohodu prostredníctvom odbornej starostlivosti a prémiových služieb.",
    contact: "Kontakt",
    hours: "Otváracie hodiny",
    weekdays: "Pondelok - Piatok: 9:00 - 20:00",
    saturday: "Sobota: 10:00 - 18:00",
    sunday: "Nedeľa: Zatvorené",
    copyright: "© 2025 Salón krásy Gigi Corner. Všetky práva vyhradené.",
  },
